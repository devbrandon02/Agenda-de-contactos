			...
			<div className={classes.container}>
				<div className={classes.containerLogin}>
					...
					>
						...
						<Form.Group>
							<Form.Label>Nombre: <span className={classes.spanRequired}>*</span></Form.Label>
							<Form.Control
							...
							<Form.Label>Email: <span className={classes.spanRequired}>*</span></Form.Label>
							<Form.Control
								className={classes.inputForm}
								type="email"
								minlenght="5"
						...
						<Form.Label>Contraseña: <span className={classes.spanRequired}>*</span></Form.Label>
							<Form.Control
								className={classes.inputForm}
								type="password"
								minlenght="6"
